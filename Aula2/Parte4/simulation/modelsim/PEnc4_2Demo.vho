...
-- Equation(s):
-- \inst|validOut~1_combout\ = (\SW[1]~input_o\) # ((\SW[0]~input_o\) # (\SW[3]~input_o\ $ (!\SW[2]~input_o\)))
...
-- Equation(s):
-- \inst|encodedOut[0]~0_combout\ = (\SW[2]~input_o\) # ((\SW[0]~input_o\) # (\SW[3]~input_o\ $ (!\SW[1]~input_o\)))
