...
\inst|Mult0|auto_generated|mac_mult1_DATAA_bus\ <= (\SW[5]~input_o\ & \SW[4]~input_o\ & \SW[3]~input_o\ & \SW[2]~input_o\ & \SW[1]~input_o\ & \SW[0]~input_o\ & gnd & gnd & gnd);

\inst|Mult0|auto_generated|mac_mult1_DATAB_bus\ <= (\SW[11]~input_o\ & \SW[10]~input_o\ & \SW[9]~input_o\ & \SW[8]~input_o\ & \SW[7]~input_o\ & \SW[6]~input_o\ & gnd & gnd & gnd);
...
-- Equation(s):
-- \inst|m[5]~0_combout\ = (!\SW[12]~input_o\ & (\SW[13]~input_o\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT11\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst|m[4]~1_combout\ = (!\SW[12]~input_o\ & (\SW[13]~input_o\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT10\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst|m[3]~2_combout\ = (!\SW[12]~input_o\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT9\ & (\SW[13]~input_o\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst|m[2]~3_combout\ = (!\SW[12]~input_o\ & (\SW[13]~input_o\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT8\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst|m[1]~4_combout\ = (!\SW[12]~input_o\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT7\ & (\SW[13]~input_o\ & !\SW[14]~input_o\)))
...
-- Equation(s):
-- \inst|m[0]~5_combout\ = (!\SW[12]~input_o\ & (!\SW[14]~input_o\ & (\SW[13]~input_o\ & \inst|Mult0|auto_generated|mac_out2~DATAOUT6\)))
...
-- Equation(s):
-- \inst|Mux0~0_combout\ = (\SW[14]~input_o\) # ((\SW[12]~input_o\ & \SW[13]~input_o\))
...
-- Equation(s):
-- \inst|Add0~0_combout\ = \SW[11]~input_o\ $ (\SW[12]~input_o\)
...
-- Equation(s):
-- \inst|Add0~1_combout\ = \SW[10]~input_o\ $ (\SW[12]~input_o\)
...
-- Equation(s):
-- \inst|Add0~2_combout\ = \SW[12]~input_o\ $ (\SW[9]~input_o\)
...
-- Equation(s):
-- \inst|Add0~3_combout\ = \SW[12]~input_o\ $ (\SW[8]~input_o\)
...
-- Equation(s):
-- \inst|Add0~4_combout\ = \SW[7]~input_o\ $ (\SW[12]~input_o\)
...
-- Equation(s):
-- \inst|Add0~5_combout\ = \SW[12]~input_o\ $ (\SW[6]~input_o\)
...
-- Equation(s):
-- \inst|Add0~8_combout\ = (\inst|Add0~5_combout\ & ((\SW[0]~input_o\ & (\inst|Add0~7_cout\ & VCC)) # (!\SW[0]~input_o\ & (!\inst|Add0~7_cout\)))) # (!\inst|Add0~5_combout\ & ((\SW[0]~input_o\ & (!\inst|Add0~7_cout\)) # (!\SW[0]~input_o\ & 
-- ((\inst|Add0~7_cout\) # (GND)))))
-- \inst|Add0~9\ = CARRY((\inst|Add0~5_combout\ & (!\SW[0]~input_o\ & !\inst|Add0~7_cout\)) # (!\inst|Add0~5_combout\ & ((!\inst|Add0~7_cout\) # (!\SW[0]~input_o\))))
...
-- Equation(s):
-- \inst|Add0~10_combout\ = ((\inst|Add0~4_combout\ $ (\SW[1]~input_o\ $ (!\inst|Add0~9\)))) # (GND)
-- \inst|Add0~11\ = CARRY((\inst|Add0~4_combout\ & ((\SW[1]~input_o\) # (!\inst|Add0~9\))) # (!\inst|Add0~4_combout\ & (\SW[1]~input_o\ & !\inst|Add0~9\)))
...
-- Equation(s):
-- \inst|Add0~12_combout\ = (\SW[2]~input_o\ & ((\inst|Add0~3_combout\ & (\inst|Add0~11\ & VCC)) # (!\inst|Add0~3_combout\ & (!\inst|Add0~11\)))) # (!\SW[2]~input_o\ & ((\inst|Add0~3_combout\ & (!\inst|Add0~11\)) # (!\inst|Add0~3_combout\ & ((\inst|Add0~11\) 
-- # (GND)))))
-- \inst|Add0~13\ = CARRY((\SW[2]~input_o\ & (!\inst|Add0~3_combout\ & !\inst|Add0~11\)) # (!\SW[2]~input_o\ & ((!\inst|Add0~11\) # (!\inst|Add0~3_combout\))))
...
-- Equation(s):
-- \inst|Add0~14_combout\ = ((\inst|Add0~2_combout\ $ (\SW[3]~input_o\ $ (!\inst|Add0~13\)))) # (GND)
-- \inst|Add0~15\ = CARRY((\inst|Add0~2_combout\ & ((\SW[3]~input_o\) # (!\inst|Add0~13\))) # (!\inst|Add0~2_combout\ & (\SW[3]~input_o\ & !\inst|Add0~13\)))
...
-- Equation(s):
-- \inst|Add0~16_combout\ = (\inst|Add0~1_combout\ & ((\SW[4]~input_o\ & (\inst|Add0~15\ & VCC)) # (!\SW[4]~input_o\ & (!\inst|Add0~15\)))) # (!\inst|Add0~1_combout\ & ((\SW[4]~input_o\ & (!\inst|Add0~15\)) # (!\SW[4]~input_o\ & ((\inst|Add0~15\) # (GND)))))
-- \inst|Add0~17\ = CARRY((\inst|Add0~1_combout\ & (!\SW[4]~input_o\ & !\inst|Add0~15\)) # (!\inst|Add0~1_combout\ & ((!\inst|Add0~15\) # (!\SW[4]~input_o\))))
...
-- Equation(s):
-- \inst|Add0~18_combout\ = \inst|Add0~0_combout\ $ (\inst|Add0~17\ $ (!\SW[5]~input_o\))
...
PORT MAP (
	...
	datac => \inst|Mult0|auto_generated|mac_out2~DATAOUT5\,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\ = (!\SW[10]~input_o\ & (!\SW[8]~input_o\ & (!\SW[9]~input_o\ & !\SW[11]~input_o\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|selnose\(0) = (\SW[7]~input_o\) # (((\SW[6]~input_o\ & !\SW[5]~input_o\)) # (!\inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[7]~0_combout\ = (\SW[6]~input_o\ & (!\SW[4]~input_o\ & \SW[7]~input_o\)) # (!\SW[6]~input_o\ & ((!\SW[7]~input_o\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ = (\SW[5]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[7]~0_combout\) # (!\inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[7]~0_combout\,
	datac => \SW[5]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|selnose[7]~1_combout\ = (\SW[7]~input_o\ & (((!\SW[4]~input_o\ & \SW[6]~input_o\)) # (!\SW[5]~input_o\))) # (!\SW[7]~input_o\ & (!\SW[4]~input_o\ & ((\SW[6]~input_o\))))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ = \SW[4]~input_o\ $ (((!\inst|Mod0|auto_generated|divider|divider|selnose[7]~1_combout\ & (\inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\ & \SW[6]~input_o\))))
...
PORT MAP (
	...
	datab => \inst|Mod0|auto_generated|divider|divider|selnose[0]~0_combout\,
	datac => \SW[4]~input_o\,
	datad => \SW[6]~input_o\,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\ = (\SW[3]~input_o\ & ((GND) # (!\SW[6]~input_o\))) # (!\SW[3]~input_o\ & (\SW[6]~input_o\ $ (GND)))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\ = CARRY((\SW[3]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & ((\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & 
...
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[7]~input_o\ & ((!\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\))) # 
-- (!\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\ = ((\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ $ (\SW[8]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[2]~5\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ & ((!\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\) # (!\SW[8]~input_o\))) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ & (!\SW[8]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|selnose\(14) = (\SW[10]~input_o\) # ((\SW[11]~input_o\) # ((\inst|Mod0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\) # (\SW[9]~input_o\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\ = (\inst|Mod0|auto_generated|divider|divider|selnose\(14) & ((\SW[3]~input_o\))) # (!\inst|Mod0|auto_generated|divider|divider|selnose\(14) & 
...
-- pragma translate_on
PORT MAP (
	datab => \inst|Mod0|auto_generated|divider|divider|selnose\(14),
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\ = (\SW[2]~input_o\ & ((GND) # (!\SW[6]~input_o\))) # (!\SW[2]~input_o\ & (\SW[6]~input_o\ $ (GND)))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\ = CARRY((\SW[2]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~2_combout\ = (\inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\ & ((\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)) # 
-- (!\SW[7]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\ & VCC)))) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\ & ((\SW[7]~input_o\ & 
-- ((\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\) # (GND))) # (!\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\))))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\ & (\SW[7]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\ & ((\SW[7]~input_o\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Mod0|auto_generated|divider|divider|StageOut[12]~5_combout\,
	datab => \SW[7]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~4_combout\ = ((\SW[8]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|StageOut[13]~4_combout\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ = CARRY((\SW[8]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[13]~4_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)) # 
-- (!\SW[8]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[13]~4_combout\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\))))
...
PORT MAP (
	dataa => \SW[8]~input_o\,
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[13]~4_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[3]~6_combout\ = (\inst|Mod0|auto_generated|divider|divider|StageOut[14]~3_combout\ & ((\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\)) # 
-- (!\SW[9]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ & VCC)))) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[14]~3_combout\ & ((\SW[9]~input_o\ & 
-- ((\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\) # (GND))) # (!\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\))))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[3]~7\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[14]~3_combout\ & (\SW[9]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[14]~3_combout\ & ((\SW[9]~input_o\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\))))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|selnose\(21) = (\inst|Mod0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\) # ((\SW[11]~input_o\) # (\SW[10]~input_o\))
...
PORT MAP (
	...
	datad => \inst|Mod0|auto_generated|divider|divider|selnose\(21),
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\ = (\inst|Mod0|auto_generated|divider|divider|selnose\(21) & (\SW[2]~input_o\)) # (!\inst|Mod0|auto_generated|divider|divider|selnose\(21) & 
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~0_combout\ = (\SW[6]~input_o\ & (\SW[1]~input_o\ $ (VCC))) # (!\SW[6]~input_o\ & ((\SW[1]~input_o\) # (GND)))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\ = CARRY((\SW[1]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[1]~2_combout\ = (\inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\ & ((\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\)) # 
-- (!\SW[7]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\ & VCC)))) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\ & ((\SW[7]~input_o\ & 
-- ((\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\) # (GND))) # (!\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\))))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\ & (\SW[7]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\ & ((\SW[7]~input_o\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\,
	datab => \SW[7]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~4_combout\ = ((\SW[8]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|StageOut[19]~8_combout\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\ = CARRY((\SW[8]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[19]~8_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\)) # 
-- (!\SW[8]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[19]~8_combout\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\))))
...
PORT MAP (
	dataa => \SW[8]~input_o\,
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[19]~8_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[3]~6_combout\ = (\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\ & ((\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\)) # 
-- (!\SW[9]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\ & VCC)))) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\ & ((\SW[9]~input_o\ & 
-- ((\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\) # (GND))) # (!\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\))))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\ & (\SW[9]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\ & ((\SW[9]~input_o\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\))))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[4]~8_combout\ = ((\SW[10]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[4]~9\ = CARRY((\SW[10]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\)) # 
-- (!\SW[10]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\))))
...
PORT MAP (
	dataa => \SW[10]~input_o\,
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\,
	datad => VCC,
...
-- (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\)) # (!\SW[11]~input_o\ & 
...
PORT MAP (
	...
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[21]~6_combout\,
	datac => \SW[11]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[4]~8_combout\,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\ = (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\)) # (!\SW[11]~input_o\ & 
...
PORT MAP (
	dataa => \inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\,
	datab => \inst|Mod0|auto_generated|divider|divider|StageOut[20]~7_combout\,
	datac => \SW[11]~input_o\,
...
-- (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[19]~8_combout\))) # (!\SW[11]~input_o\ & 
...
-- (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\))) # (!\SW[11]~input_o\ & 
...
PORT MAP (
	...
	datac => \SW[11]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|StageOut[18]~9_combout\,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\ = (\SW[11]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[11]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[1]~input_o\))) # 
-- (!\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_4_result_int[0]~0_combout\))))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~0_combout\ = (\SW[6]~input_o\ & (\SW[0]~input_o\ $ (VCC))) # (!\SW[6]~input_o\ & ((\SW[0]~input_o\) # (GND)))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~1\ = CARRY((\SW[0]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~2_combout\ = (\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~1\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\ & ((\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~1\) # (GND))))) # (!\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\ & 
...
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~3\ = CARRY((\SW[7]~input_o\ & ((!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~1\) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\))) # 
-- (!\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[0]~1\)))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~4_combout\ = ((\SW[8]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|StageOut[25]~13_combout\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~3\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\ = CARRY((\SW[8]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|StageOut[25]~13_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~3\)) # 
-- (!\SW[8]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[25]~13_combout\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~3\))))
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~6_combout\ = (\inst|Mod0|auto_generated|divider|divider|StageOut[26]~12_combout\ & ((\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\)) # 
-- (!\SW[9]~input_o\ & (\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\ & VCC)))) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[26]~12_combout\ & ((\SW[9]~input_o\ & 
-- ((\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\) # (GND))) # (!\SW[9]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\))))
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~7\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[26]~12_combout\ & (\SW[9]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[26]~12_combout\ & ((\SW[9]~input_o\) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[2]~5\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Mod0|auto_generated|divider|divider|StageOut[26]~12_combout\,
	datab => \SW[9]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~8_combout\ = ((\inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\ $ (\SW[10]~input_o\ $ (\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~7\)))) # (GND)
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~9\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\ & ((!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~7\) # (!\SW[10]~input_o\))) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\ & (!\SW[10]~input_o\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~7\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\,
	datab => \SW[10]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[5]~10_combout\ = (\SW[11]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\ & (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~9\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\ & ((\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~9\) # (GND))))) # (!\SW[11]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\ & 
...
-- \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[5]~11\ = CARRY((\SW[11]~input_o\ & ((!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~9\) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\))) # 
-- (!\SW[11]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\ & !\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[4]~9\)))
...
PORT MAP (
	...
	datac => \inst|Mod0|auto_generated|divider|divider|StageOut[28]~10_combout\,
	datad => \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\,
...
-- Equation(s):
-- \inst|Mux0~4_combout\ = (\inst|Mux0~3_combout\ & ((\SW[12]~input_o\) # ((\SW[13]~input_o\) # (\inst|Mod0|auto_generated|divider|divider|StageOut[35]~15_combout\))))
...
PORT MAP (
	...
	datac => \SW[13]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|StageOut[35]~15_combout\,
...
PORT MAP (
	...
	datad => \inst|Mod0|auto_generated|divider|divider|StageOut[27]~11_combout\,
...
-- Equation(s):
-- \inst|Mux1~3_combout\ = (\inst|Mux1~2_combout\ & ((\SW[12]~input_o\) # ((\SW[13]~input_o\) # (\inst|Mod0|auto_generated|divider|divider|StageOut[34]~16_combout\))))
...
PORT MAP (
	...
	datac => \SW[13]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|StageOut[34]~16_combout\,
	combout => \inst|Mux1~3_combout\);

-- Location: LCCOMB_X97_Y17_N4
\inst|Mux1~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Mux1~0_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Equal0~0_combout\) # ((\inst|Mux1~3_combout\)))) # (!\inst|Mux0~0_combout\ & (!\inst|Equal0~0_combout\ & (\inst|Add0~16_combout\)))
...
-- Equation(s):
-- \inst|Mux2~0_combout\ = (\inst|Equal0~0_combout\ & (((\inst|Mux0~0_combout\) # (\inst|Mult0|auto_generated|mac_out2~DATAOUT3\)))) # (!\inst|Equal0~0_combout\ & (\inst|Add0~14_combout\ & (!\inst|Mux0~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\,
	datac => \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[3]~6_combout\,
...
-- Equation(s):
-- \inst|Mux2~3_combout\ = (\inst|Mux2~2_combout\ & ((\SW[12]~input_o\) # ((\inst|Mod0|auto_generated|divider|divider|StageOut[33]~17_combout\) # (\SW[13]~input_o\))))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~0_combout\ = (\SW[3]~input_o\ & ((GND) # (!\SW[6]~input_o\))) # (!\SW[3]~input_o\ & (\SW[6]~input_o\ $ (GND)))
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\ = CARRY((\SW[3]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~2_combout\ = (\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (GND))))) # (!\SW[7]~input_o\ & ((\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & 
-- (\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\ & VCC)) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\))))
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\ = CARRY((\SW[7]~input_o\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\) # (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\))) # 
-- (!\SW[7]~input_o\ & (!\inst|Mod0|auto_generated|divider|divider|StageOut[6]~2_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[0]~1\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~4_combout\ = ((\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ $ (\SW[8]~input_o\ $ (\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))) # (GND)
-- \inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[2]~5\ = CARRY((\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\) # (!\SW[8]~input_o\))) # 
-- (!\inst|Mod0|auto_generated|divider|divider|StageOut[7]~1_combout\ & (!\SW[8]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[1]~3\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|selnose\(14) = (\SW[10]~input_o\) # ((\inst|Div0|auto_generated|divider|divider|add_sub_2_result_int[3]~6_combout\) # ((\SW[9]~input_o\) # (\SW[11]~input_o\)))
...
-- Equation(s):
-- \inst|Mux2~1_combout\ = (\inst|Mux2~0_combout\ & (((!\inst|Div0|auto_generated|divider|divider|selnose\(14))) # (!\inst|Mux0~0_combout\))) # (!\inst|Mux2~0_combout\ & (\inst|Mux0~0_combout\ & (\inst|Mux2~3_combout\)))
...
PORT MAP (
	...
	datad => \inst|Div0|auto_generated|divider|divider|selnose\(14),
	combout => \inst|Mux2~1_combout\);

-- Location: LCCOMB_X94_Y17_N18
\inst|Mux3~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Mux3~2_combout\ = (\SW[8]~input_o\ & ((\SW[2]~input_o\ $ (\SW[13]~input_o\)) # (!\SW[12]~input_o\))) # (!\SW[8]~input_o\ & ((\SW[13]~input_o\ & ((\SW[2]~input_o\))) # (!\SW[13]~input_o\ & (!\SW[12]~input_o\))))
...
PORT MAP (
	...
	datac => \inst|Mod0|auto_generated|divider|divider|StageOut[25]~13_combout\,
	datad => \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\,
...
-- Equation(s):
-- \inst|Mux3~3_combout\ = (\inst|Mux3~2_combout\ & ((\SW[12]~input_o\) # ((\inst|Mod0|auto_generated|divider|divider|StageOut[32]~18_combout\) # (\SW[13]~input_o\))))
...
-- Equation(s):
-- \inst|Mux3~0_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Mux3~3_combout\) # ((\inst|Equal0~0_combout\)))) # (!\inst|Mux0~0_combout\ & (((!\inst|Equal0~0_combout\ & \inst|Add0~12_combout\))))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\ = (\inst|Div0|auto_generated|divider|divider|selnose\(14) & ((\SW[3]~input_o\))) # (!\inst|Div0|auto_generated|divider|divider|selnose\(14) & 
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~0_combout\ = (\SW[2]~input_o\ & ((GND) # (!\SW[6]~input_o\))) # (!\SW[2]~input_o\ & (\SW[6]~input_o\ $ (GND)))
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\ = CARRY((\SW[2]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~2_combout\ = (\SW[7]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\) # (GND))))) # (!\SW[7]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\ & 
...
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\ = CARRY((\SW[7]~input_o\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\) # (!\inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\))) # 
-- (!\SW[7]~input_o\ & (!\inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[0]~1\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~4_combout\ = ((\inst|Div0|auto_generated|divider|divider|StageOut[13]~1_combout\ $ (\SW[8]~input_o\ $ (\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))) # (GND)
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[13]~1_combout\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\) # (!\SW[8]~input_o\))) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[13]~1_combout\ & (!\SW[8]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~3\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[3]~6_combout\ = (\SW[9]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\) # (GND))))) # (!\SW[9]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\ & 
-- (\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\ & VCC)) # (!\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\))))
-- \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[3]~7\ = CARRY((\SW[9]~input_o\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\) # (!\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\))) # 
-- (!\SW[9]~input_o\ & (!\inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~5\)))
...
PORT MAP (
	dataa => \SW[9]~input_o\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[14]~0_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|selnose\(21) = (\inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[4]~8_combout\) # ((\SW[11]~input_o\) # (\SW[10]~input_o\))
...
-- Equation(s):
-- \inst|Mux3~1_combout\ = (\inst|Mux3~0_combout\ & (((!\inst|Div0|auto_generated|divider|divider|selnose\(21)) # (!\inst|Equal0~0_combout\)))) # (!\inst|Mux3~0_combout\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT2\ & (\inst|Equal0~0_combout\)))
...
PORT MAP (
	...
	datac => \inst|Equal0~0_combout\,
	datad => \inst|Div0|auto_generated|divider|divider|selnose\(21),
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[2]~4_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|StageOut[12]~2_combout\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_3_result_int[1]~2_combout\,
	datad => \inst|Div0|auto_generated|divider|divider|selnose\(21),
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ = (\inst|Div0|auto_generated|divider|divider|selnose\(21) & ((\SW[2]~input_o\))) # (!\inst|Div0|auto_generated|divider|divider|selnose\(21) & 
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~0_combout\ = (\SW[1]~input_o\ & ((GND) # (!\SW[6]~input_o\))) # (!\SW[1]~input_o\ & (\SW[6]~input_o\ $ (GND)))
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\ = CARRY((\SW[1]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~2_combout\ = (\SW[7]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\) # (GND))))) # (!\SW[7]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ & 
-- (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\ & VCC)) # (!\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\))))
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\ = CARRY((\SW[7]~input_o\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\) # (!\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\))) # 
-- (!\SW[7]~input_o\ & (!\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~1\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~4_combout\ = ((\inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\ $ (\SW[8]~input_o\ $ (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\)))) # (GND)
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\) # (!\SW[8]~input_o\))) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\ & (!\SW[8]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~3\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\,
	datab => \SW[8]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~6_combout\ = (\SW[9]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\) # (GND))))) # (!\SW[9]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\ & 
-- (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\ & VCC)) # (!\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\ & (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\))))
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\ = CARRY((\SW[9]~input_o\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\) # (!\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\))) # 
-- (!\SW[9]~input_o\ & (!\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~5\)))
...
PORT MAP (
	dataa => \SW[9]~input_o\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[4]~8_combout\ = ((\SW[10]~input_o\ $ (\inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\ $ (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\)))) # (GND)
-- \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[4]~9\ = CARRY((\SW[10]~input_o\ & (\inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\)) # 
-- (!\SW[10]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\) # (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~7\))))
...
PORT MAP (
	dataa => \SW[10]~input_o\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|selnose\(28) = (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\) # (\SW[11]~input_o\)
...
-- Equation(s):
-- \inst|Mux4~2_combout\ = (\SW[1]~input_o\ & ((\SW[7]~input_o\ $ (\SW[13]~input_o\)) # (!\SW[12]~input_o\))) # (!\SW[1]~input_o\ & ((\SW[13]~input_o\ & ((\SW[7]~input_o\))) # (!\SW[13]~input_o\ & (!\SW[12]~input_o\))))
...
PORT MAP (
	...
	datab => \inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[1]~2_combout\,
	datac => \inst|Mod0|auto_generated|divider|divider|StageOut[24]~14_combout\,
...
-- Equation(s):
-- \inst|Mux4~3_combout\ = (\inst|Mux4~2_combout\ & ((\SW[12]~input_o\) # ((\SW[13]~input_o\) # (\inst|Mod0|auto_generated|divider|divider|StageOut[31]~19_combout\))))
...
PORT MAP (
	...
	datac => \SW[13]~input_o\,
	datad => \inst|Mod0|auto_generated|divider|divider|StageOut[31]~19_combout\,
	combout => \inst|Mux4~3_combout\);

-- Location: LCCOMB_X97_Y17_N24
\inst|Mux4~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|Mux4~0_combout\ = (\inst|Mux0~0_combout\ & (\inst|Equal0~0_combout\)) # (!\inst|Mux0~0_combout\ & ((\inst|Equal0~0_combout\ & (\inst|Mult0|auto_generated|mac_out2~DATAOUT1\)) # (!\inst|Equal0~0_combout\ & ((\inst|Add0~10_combout\)))))
...
-- Equation(s):
-- \inst|Mux4~1_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Mux4~0_combout\ & (!\inst|Div0|auto_generated|divider|divider|selnose\(28))) # (!\inst|Mux4~0_combout\ & ((\inst|Mux4~3_combout\))))) # (!\inst|Mux0~0_combout\ & (((\inst|Mux4~0_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|selnose\(28),
...
-- (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\))) # (!\SW[11]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[4]~8_combout\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[21]~3_combout\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\,
	datad => \SW[11]~input_o\,
...
-- (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\))) # (!\SW[11]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[3]~6_combout\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[20]~4_combout\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\,
	datad => \SW[11]~input_o\,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|StageOut[26]~9_combout\ = (\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & (((\inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\)))) # 
-- (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[19]~5_combout\))) # (!\SW[11]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[2]~4_combout\,
...
-- (!\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[11]~input_o\ & (\inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\)) # (!\SW[11]~input_o\ & 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\,
	datab => \inst|Div0|auto_generated|divider|divider|StageOut[18]~6_combout\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[1]~2_combout\,
	datad => \SW[11]~input_o\,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|StageOut[24]~11_combout\ = (\SW[11]~input_o\ & (((\SW[1]~input_o\)))) # (!\SW[11]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\ & ((\SW[1]~input_o\))) # 
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[0]~0_combout\,
	datab => \SW[11]~input_o\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_4_result_int[5]~10_combout\,
	datad => \SW[1]~input_o\,
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[0]~1_cout\ = CARRY((\SW[0]~input_o\) # (!\SW[6]~input_o\))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[1]~3_cout\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[24]~11_combout\ & (\SW[7]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[0]~1_cout\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[24]~11_combout\ & ((\SW[7]~input_o\) # (!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[0]~1_cout\))))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[2]~5_cout\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[25]~10_combout\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[1]~3_cout\) # (!\SW[8]~input_o\))) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[25]~10_combout\ & (!\SW[8]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[1]~3_cout\)))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[3]~7_cout\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[26]~9_combout\ & (\SW[9]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[2]~5_cout\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[26]~9_combout\ & ((\SW[9]~input_o\) # (!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[2]~5_cout\))))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[4]~9_cout\ = CARRY((\SW[10]~input_o\ & (\inst|Div0|auto_generated|divider|divider|StageOut[27]~8_combout\ & !\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[3]~7_cout\)) # 
-- (!\SW[10]~input_o\ & ((\inst|Div0|auto_generated|divider|divider|StageOut[27]~8_combout\) # (!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[3]~7_cout\))))
...
-- Equation(s):
-- \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[5]~11_cout\ = CARRY((\inst|Div0|auto_generated|divider|divider|StageOut[28]~7_combout\ & (\SW[11]~input_o\ & !\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[4]~9_cout\)) # 
-- (!\inst|Div0|auto_generated|divider|divider|StageOut[28]~7_combout\ & ((\SW[11]~input_o\) # (!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[4]~9_cout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \inst|Div0|auto_generated|divider|divider|StageOut[28]~7_combout\,
	datab => \SW[11]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \inst|Mux5~0_combout\ = (\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\ & (((\SW[0]~input_o\)))) # (!\inst|Mod0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\ & ((\SW[12]~input_o\ & ((\SW[0]~input_o\))) # 
...
-- Equation(s):
-- \inst|Mux5~1_combout\ = (\SW[13]~input_o\ & (\SW[12]~input_o\)) # (!\SW[13]~input_o\ & (\inst|Mux5~0_combout\ & ((\SW[6]~input_o\) # (!\SW[12]~input_o\))))
...
-- Equation(s):
-- \inst|Mux5~2_combout\ = (\SW[13]~input_o\ & ((\SW[6]~input_o\ & ((!\SW[0]~input_o\) # (!\inst|Mux5~1_combout\))) # (!\SW[6]~input_o\ & ((\SW[0]~input_o\))))) # (!\SW[13]~input_o\ & (((\inst|Mux5~1_combout\))))
...
-- Equation(s):
-- \inst|Mux5~3_combout\ = (\inst|Mux0~0_combout\ & ((\inst|Equal0~0_combout\) # ((\inst|Mux5~2_combout\)))) # (!\inst|Mux0~0_combout\ & (!\inst|Equal0~0_combout\ & ((\inst|Add0~8_combout\))))
...
-- Equation(s):
-- \inst|Mux5~4_combout\ = (\inst|Equal0~0_combout\ & ((\inst|Mux5~3_combout\ & ((!\inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\))) # (!\inst|Mux5~3_combout\ & (\inst|Mult0|auto_generated|mac_out2~dataout\)))) # 
-- (!\inst|Equal0~0_combout\ & (((\inst|Mux5~3_combout\))))
...
PORT MAP (
	...
	datab => \inst|Equal0~0_combout\,
	datac => \inst|Div0|auto_generated|divider|divider|add_sub_5_result_int[6]~12_combout\,
